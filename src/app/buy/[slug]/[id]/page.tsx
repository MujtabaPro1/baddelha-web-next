      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <nav className="mb-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            <a href="/buy" className="hover:text-red-500 transition">{lang[language].buy}</a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-4 gap-4 mt-6">
                <div className="text-center border-r border-gray-200 last:border-r-0">
                  <div className="text-sm text-gray-500">{lang[language].year}</div>
                  <div className="font-semibold mt-1">{car?.year || '2022'}</div>
                </div>
                <div className="text-center border-r border-gray-200 last:border-r-0">
                  <div className="text-sm text-gray-500">{lang[language].mileage}</div>
                  <div className="font-semibold mt-1">{car?.mileage ? car.mileage.toLocaleString() : '42,500'} km</div>
                </div>
                <div className="text-center border-r border-gray-200 last:border-r-0">
                  <div className="text-sm text-gray-500">{lang[language].fuelType}</div>
                  <div className="font-semibold mt-1">{car?.fuelType || 'Petrol'}</div>
                </div>
                <div className="text-center border-r border-gray-200 last:border-r-0">
                  <div className="text-sm text-gray-500">{lang[language].transmission}</div>
                      ...
                      <table className="min-w-full">
                        <tbody>
                          <tr className="border-b border-gray-200">
                            <td className="py-3 text-sm text-gray-500 w-1/2">{lang[language].make}</td>
                  ...
                  <div className="space-y-8">
                    <div>
                      <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center">
                        <Check className="h-5 w-5 mr-2 text-[#f78f37]" /> {lang[language].keyFeatures}
                      </h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <Star className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].comfortFeatures}
                          </h4>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <Zap className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].technologyFeatures}
                          </h4>
                          <ul className="space-y-2">
                            {[
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <Shield className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].safetyFeatures}
                          </h4>
                          <ul className="space-y-2">
                            {[
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <Award className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].performanceFeatures}
                          </h4>
                          <ul className="space-y-2">
                            {[
                              'Sport Suspension',
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <Car className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].exterior}
                          </h4>
                          <ul className="space-y-2">
                            {[
                              'LED Headlights',
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3 text-gray-700 flex items-center">
                            <ThumbsUp className="h-4 w-4 mr-2 text-[#f78f37]" /> {lang[language].convenienceFeatures}
                          </h4>
                          <ul className="space-y-2">
                            {[
                              'Keyless Entry & Start',
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center">
                        <Plus className="h-5 w-5 mr-2 text-[#f78f37]" /> {lang[language].additionalFeaturesTitle}
                      </h3>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <h4 className="font-semibold mb-2 text-gray-700">{lang[language].premiumPackage}</h4>
                          ...
                          <div>
                            <h4 className="font-semibold mb-2 text-gray-700">{lang[language].sportPackage}</h4>
                            <ul className="space-y-1">
                              {[
                                'Sport Seats',
                  ...
                  <div>
                    ...
                    <div className="mt-6 text-center">
                      <button className="bg-white hover:bg-gray-50 text-red-500 font-medium py-2 px-6 rounded border border-red-500 transition inline-flex items-center text-sm">
                        {lang[language].viewMoreSimilarCars} <ArrowRight className="h-4 w-4 ml-2" />
                      </button>
                    </div>
                  </div>
                )}
          ...
          <div className="space-y-6">
            ...
            {/* Seller Info */}
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-medium mb-4">{lang[language].sellerInfo}</h3>
              <div className="flex items-center mb-4">
                ...
                <div>
                  <div className="font-medium">{car?.seller?.name || 'Certified Seller'}</div>
                </div>
              </div>
