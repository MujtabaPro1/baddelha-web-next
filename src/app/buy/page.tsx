...
function Buy() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 pt-[60px]">
      {/* Hero Section */}
      <div className="bg-[#3d3d40] text-white py-16 lg:py-16">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 md:gap-4">
                ...
                <div className="flex items-center gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto">
                  ...
                  <div className="relative flex-1 sm:flex-none">
                    ...
                    >
                       <option value="cars">{t.sortRecommended}</option>
                      <option value="cars:sellingPrice:asc">{t.sortPriceLowToHigh}</option>
                      <option value="cars:sellingPrice:desc">{t.sortPriceHighToLow}</option>
                      <option value="cars:modelYear:desc">{t.sortYearNewest}</option>
                      <option value="cars:modelYear:asc">{t.sortYearOldest}</option>
          ...
          <div className="flex-1 p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm h-[60px]">
              <div className="flex items-start flex-col text-gray-600">
                <p className="font-medium">{t.mileage} &nbsp;</p>
              ...
              <div className="flex items-start flex-col text-gray-600">
                <p className="font-medium">{t.fuelType} &nbsp;</p>
                <div className="flex items-center">
                  <Fuel className="h-4 w-4 mr-2 text-[#f78f37]" />
                  <span className="font-bold">{car.fuelType || t.petrol}</span>
                </div>
              </div>
              <div className="flex items-start flex-col text-gray-600">
                ...
                <div className="flex items-center">
                  ...
                  <span className="font-bold">{car.transmission || t.automatic}</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                {t.soldBy}: <span className="font-medium">{car?.organizationId ? t.company : t.private}</span>
              </div>
