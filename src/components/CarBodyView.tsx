...
type BodyCondition = {
  [key: string]: 'original' | 'damaged' | 'repainted' | 'notAvailable' | 'painted';
};
...
const CarBodySvgView: React.FC<CarBodySvgProps> = ({
  ...
  return (
    ...
    <path id="rear_left_wing" className={getPartClass('c_n_wing_rear_left')} 
       fill="#F5F5F7" stroke="#032D37" stroke-width="1" d="M223.4,455.8c-4.6,6.6-18.2,20.2-37.5,33.4
    ...
    <path id="front_left_door" className={getPartClass('c_n_door_front_left')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M187.5,400.8c8.6,0.9,33.8,1.7,38,2.3
    ...
    <path id="front_left_lock" fill="#000" stroke="#032D37" strokeWidth="2" d="M171.3,377.5v12.8c0,0.6-1.2,1.1-2.6,1.1
    ...
    <path id="rear_left_door" className={getPartClass('c_n_door_rear_left')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M159,482.6c5.6,9.6,7.6,19.7,26.9,6.6
    ...
    <path id="rear_left_lock" fill="#000" stroke="#032D37" strokeWidth="2" d="M171.3,470.2v12.7c0,0.6-1.2,1.1-2.6,1.1
    ...
    <path id="front_left_wing" className={getPartClass('c_n_wing_front_left')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M156.6,293.2c8,0,22.4,1.5,33.9,6.6
    ...
    <path id="trunk" className={getPartClass('c_n_boot')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M337.6,475c0,0-17.2-4.6-26.3-4.6h-52.7
    ...
    <path id="windscreen" className={getPartClass('c_n_windscreen')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M351.2,298.3L337.5,349c0,0-17.7-3-25.9-3h-53.1
    ...
    <path id="rear_screen" className={getPartClass('c_n_rear_screen')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M330.9,479c0,0-14.7-3-20.2-3h-52.2
    ...
    <path id="left_headlight" fill="#F5F5F7" d="M227.4,153.6h9.3v8.1v8.1h-9.3h-9.3v-8.2v-8.1L227.4,153.6L227.4,153.6z" />
    <path id="right_headlight" fill="#F5F5F7"
    ...
    <path id="front_bumper" className={getPartClass('c_n_bumper_front')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M359.8,140.6c0,0,0.5-13.1-7.6-13.1H218.6
    ...
    <path id="right_taillight" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M356.5,612.4h-26.3v24.3H360l5.1-9.1L356.5,612.4
     L356.5,612.4z" />
    <path id="left_taillight" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M237.9,612.4v24.3h-28.4l-5.1-8.6l6.6-15.7H237.9
     L237.9,612.4z" />
    ...
    <path id="rear_bumper_1_" className={getPartClass('c_n_bumber_rear')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M205.1,643.4c0-4.6,3.6-6.6,3.6-6.6h150.9
    ...
    <path id="bonnet" className={getPartClass('c_n_bonnet')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M217.6,298.3c0,0,22.7-6.2,33.9-6.2l66.8,0.8
    ...
    <path id="roof" className={getPartClass('c_n_roof')} 
      fill="#F5F5F7" stroke="#000000" strokeWidth="2" d="M337.6,349c0,0-17.7-3-25.9-3h-53.1c-11.1,0-28.4,3-28.4,3
    ...
    />
    <path id="rear_left_quarter" fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M218.4,467.5c0,0-30.3,28.8-31.4,30.9
    ...
    <path id="front_left_window" className={getPartClass('c_n_front_left_window')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M219,361c2.6,10.6,2.6,37.1,2.6,37.1l-34.4-2.6
    ...
    <path id="rear_right_wing" className={getPartClass('c_n_wing_rear_right')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M345.6,455.8c4.6,6.6,18.2,20.2,37.5,33.4
    ...
    <path id="front_right_door" className={getPartClass('c_n_door_front_right')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M381.5,400.8c-8.6,0.9-33.8,1.7-38,2.3
    ...
    <path id="front_right_door_decor_2" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M436.9,400.1V295.2" />
    <path id="front_right_door_decor_1" fill="none" stroke="#032D37" strokeWidth="2" d="M416,398V292.9" />
    <path id="front_right_lock" fill="#000" stroke="#032D37" strokeWidth="2" d="M397.6,377.5c0-0.6,1.2-1.1,2.6-1.1
    ...
    <path id="rear_right_door" className={getPartClass('c_n_door_rear_right')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M410,482.6c-5.6,9.6-7.6,19.7-26.9,6.6
    ...
    <path id="rear_right_lock" fill="#000" stroke="#032D37" strokeWidth="2" d="M397.6,470.2c0-0.6,1.2-1.1,2.6-1.1
    ...
    <path id="front_right_wing" className={getPartClass('c_n_wing_front_right')} 
      fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M412.4,293.2c-8,0-22.4,1.5-33.9,6.6
    ...
    <g>
      <path id="front_left_tire" className="part" fill="#3D3D40" stroke="#032D37" strokeWidth="2" d="M124.9,279c-15.1,0-27.4-12.3-27.4-27.4
         c0-15.1,12.3-27.4,27.4-27.4c15.1,0,27.4,12.3,27.4,27.4C152.3,266.7,140,279,124.9,279z" />
 
      <path id="front_left_rim" className="part" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M124.9,267.6c-8.8,0-16-7.1-16-16
         c0-8.8,7.1-16,16-16c8.8,0,16,7.1,16,16C140.8,260.5,133.7,267.6,124.9,267.6z" />
    </g>
 
    <g>
      <path id="front_right_tire" className="part" fill="#3D3D40" stroke="#032D37" strokeWidth="2" d="M416.7,251.7c0-15.1,12.3-27.4,27.4-27.4
         s27.4,12.3,27.4,27.4c0,15.1-12.3,27.4-27.4,27.4C429,279,416.7,266.8,416.7,251.7z" />
 
      <path id="front_right_rim" className="part" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M428.2,251.8c0-8.8,7.1-16,16-16s16,7.1,16,16
         c0,8.8-7.1,16-16,16C435.3,267.6,428.2,260.5,428.2,251.8z" />
    </g>
 
    <g>
      <path id="rear_left_tire" className="part" fill="#3D3D40" stroke="#032D37" strokeWidth="2" d="M124.9,528.9c-15.1,0-27.4-12.3-27.4-27.4
     c0-15.1,12.3-27.4,27.4-27.4c15.1,0,27.3,12.3,27.3,27.4C152.2,516.6,140,528.9,124.9,528.9z" />
 
      <path id="rear_left_rim" className="part" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M124.9,517.5c-8.8,0-16-7.1-16-16s7.1-16,16-16
     c0,0,0,0,0.1,0c8.8,0,16,7.1,16,16C141,510.4,133.7,517.5,124.9,517.5L124.9,517.5z" />
    </g>
 
    <g >
      <path id="rear_right_tire" className="part" fill="#3D3D40" stroke="#032D37" strokeWidth="2" d="M416.7,501.5c0-15.1,12.3-27.4,27.4-27.4
     s27.4,12.3,27.4,27.4c0,15.1-12.3,27.4-27.4,27.4S416.7,516.7,416.7,501.5z" />
 
      <path id="rear_right_rim" className="part" fill="#F5F5F7" stroke="#032D37" strokeWidth="2" d="M444.1,517.5c-8.8,0-16-7.1-16-16s7.1-16,16-16
     c0.1,0,0.1,0,0.1,0c8.8,0,16,7.1,16,16C460.1,510.4,453,517.5,444.1,517.5L444.1,517.5z" />
    </g>
 
    <path id="rear_quarter_right_window" fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M361.4,502.9c4.1,9.3,21.1,37,21.1,37
    ...
    <path id="front_right_window" className={getPartClass('c_n_front_right_window')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M382,306.6v88.9l-34.4,2.6
    ...
    <path id="rear_left_window" className={getPartClass('c_n_rear_left_window')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M221,407.4l-33.9-1.6v74.5
    ...
    <path id="rear_right_window" className={getPartClass('c_n_rear_right_window')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M348,407.4c0.6,17-1.5,41.6,2.1,46.8
     c4.9,9.5,24.4,22.2,31.9,26.2v-74.5L348,407.4L348,407.4z" 
    />
 
    <path id="sunroof" className={getPartClass('c_sunroof_moonroof')} 
      fill="#E7F6FF" stroke="#032D37" strokeWidth="2" d="M316.5,376.8v16c0,6.2-5.6,11.2-12.4,11.2l0,0h-40.6
