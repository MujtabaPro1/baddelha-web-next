const lang = {
    en: {
        ...
        "loginToViewInspection": "Verify your phone to view the inspection report",
        "loginToViewInspectionDesc": "Quickly verify your phone number to unlock the full inspection report for this car.",
        "loginToView": "Verify to Continue",
  ...
  "buy_page": {
    ...
    perMonth: "/mo"
       ...
       ar: {
        ...
        "loginToViewInspection": "تحقق من رقم هاتفك لعرض تقرير الفحص",
        "loginToViewInspectionDesc": "تحقق من رقم هاتفك بسرعة لفتح تقرير الفحص الكامل لهذه السيارة.",
        "loginToView": "تحقق للمتابعة",
